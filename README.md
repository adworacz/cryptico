...
var Bits = 1024;
var Exponent = "03";
//Changed by adworacz for personal use, so this uses SecureRandom now and doesn't use the passphrase.
//var MattsRSAkey = cryptico.generateRSAKey(PassPhrase, Bits);
var MattsRSAkey = cryptico.generateRSAKey(Bits, Exponent);
```
